...
- **[Load Balancer](https://github.com/sunilnjc/Load-Balancer)** — A TypeScript implementation of request distribution across backend servers, including round-robin routing.
- **[Redis & Memcached](https://github.com/sunilnjc/Redis-Memcached)** — A study of Redis and Memcached operations and performance comparisons.
- **[WebSockets & Long Polling](https://github.com/sunilnjc/Websockets-Longpolling)** — A TypeScript communication-patterns project with a browser client.
- **[E-commerce Order Service](https://github.com/sunilnjc/order-ecommerce)** — A Java/Spring Boot order CRUD service with PostgreSQL, adapted from an existing Kotlin exercise.
- **[Log My Ticket](https://github.com/sunilnjc/log-my-ticket)** — A MEAN-stack application for logging tasks and incidents.
- **[Retail Store Discounts](https://github.com/sunilnjc/RetailStoreDiscouns)** — A retail discount API that applies customer-type rules, bill discounts, and grocery exclusions.
- **[React Currency](https://github.com/sunilnjc/React-currency)** — An earlier React application. See the repository for source and setup.
- **[Keyword Management Tool](https://github.com/sunilnjc/KeywordManagementTool)** — An earlier Gradle-based application. See the repository for implementation details.
- **[CompletableFuture Study](https://github.com/sunilnjc/completable-future-poc)** — A Java concurrency proof of concept inspired by Java Techie.
- **[Build Your Own Redis](https://github.com/sunilnjc/redis)** — Work on the CodeCrafters Redis challenge in Python. A learning project rather than a production Redis replacement.
- **Rate Limiter Lab** — A Node.js learning scaffold with a fixed-window limiter, middleware, stress tooling, and additional algorithms left as exercises.

## Notes from the work

- **Separate guidance from diagnostics.** A camera operator needs one clear cue; detailed evidence belongs in the report.
- **Keep a replayable history.** An immutable journal lets a ledger rebuild its projections and distinguish when an event happened from when it became known.
- **Make missing data visible.** Sensor and market-data tools should show unavailable or uncertain results explicitly.

## Connect

Find my public repositories here on [GitHub](https://github.com/sunilnjc).

*Project scope reviewed against implementation documentation in September 2026.*
